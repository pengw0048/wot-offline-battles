"""Bot driver adapter, taken from the 0.9.22 port.
...
from gui.mods.offline_battle_2312.ai.driver import LocalDriver
from gui.mods.offline_battle_2312.ai.planner import BattleDirector
