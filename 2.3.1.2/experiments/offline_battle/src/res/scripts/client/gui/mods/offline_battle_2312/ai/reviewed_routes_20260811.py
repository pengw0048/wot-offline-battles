"""Reviewed route data maps.py imports, taken from the 0.9.22 port.
...
User-reviewed tactical corridor intent for the 2.3.1.2 map set.
...
REVIEWED_ROUTE_POINTS = {
    ...
    '07_lakeville': {
        ...
        # The lake-side road is a real stock corridor.  The 2.3.1.2 graph adapter
    ...
    '59_asia_great_wall': {
        ...
        # directions, then use its real vehicle tunnel.  The 2.3.1.2 BSP2 adapter
    ...
    '84_winter': {
        ...
        # 2.3.1.2 graph adapter verifies that edge against terrain, water, BSP2,
