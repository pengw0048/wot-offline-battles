# -*- coding: utf-8 -*-
"""Conservative macro corridors retained as reviewed lane sketches.

Each route is intentionally only a chain of road, field, or open-valley
anchors. Exact objectives and team starts come from the pinned #1513 arena
data during navigation baking; the local multi-ray driver still owns collision
avoidance.
"""
...
LAKEVILLE = _map('07_lakeville', (-400.0, -400.0, 400.0, 400.0),
	(
		# These reviewed corridor gates avoid both the mountain and lake. The
		# #1513 baker projects them onto the validated terrain graph.
...
MUROVANKA = _map('11_murovanka', (-500.0, -500.0, 500.0, 500.0),
	(
