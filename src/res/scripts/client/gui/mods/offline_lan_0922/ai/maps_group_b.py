# -*- coding: utf-8 -*-
"""Sparse tactical corridors retained as reviewed lane sketches.

Waypoints follow visible roads, open banks, and map edges. Exact objectives and
team starts are decoded from the pinned #1513 resources during navigation
baking; this module deliberately contains only macro lane intent.
"""
...
def _reverse_routes(routes):
	"""Return independent routes for the opposite team on Python 2.7."""
	result = []
	for route in routes:
		copy = dict(route)
