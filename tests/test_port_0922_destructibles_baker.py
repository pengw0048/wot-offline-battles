...
DATA_ROOT = ROOT / 'destructibles'
CLIENT_SCRIPTS = (ROOT / 'src' / 'res' /
                  'scripts' / 'client')
...
class DestructiblesBaker0922Tests(unittest.TestCase):
    ...
    def test_every_catalog_version_pin_agrees(self):
        ...
        builder = ROOT / 'build_wotmod.py'
        foliage_source = ROOT / 'tools' / 'bake_foliage_0922.py'
        destructible_loader = (
        ...
        self.assertEqual(
            ...
            [pinned(foliage_loader, 'FORMAT_VERSION'),
             ...
             json.loads(
                 (ROOT / 'foliage' / 'manifest.json').read_text(
                     encoding='utf-8'))['version']])
