...
from bot_chat import (
    ...
    PERSONA_SCOUT, PERSONA_SLACKER, PERSONA_TACTICAL, REQUEST_ATTACK,
    REQUEST_BASE, REQUEST_CELL, REQUEST_FOLLOW, REQUEST_HOLD, TRIGGER_ALLY_DOWN,
